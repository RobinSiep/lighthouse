...
This package is meant to be used with the packages [Lighthouse Client](https://github.com/RobinSiep/lighthouse-client) and [Lighthouse Web](https://github.com/RobinSiep/lighthouse-web). Lighthouse Client is not yet publicly available.
